...
@Component({
  selector: 'app-enhanced-payment-result',
  standalone: true,
...
export class EnhancedPaymentResultComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (!this.paymentResponse) {
      console.error('EnhancedPaymentResultComponent: paymentResponse is required');
    }
  }
